...
FloatBox Transform::transformBox(const FloatBox& box) const
{
    ...
    const Vector3f points[] =
    {
        transformPoint(box.x, box.y, box.z),
        transformPoint(box.x, box.y + box.height, box.z),
        transformPoint(box.x + box.width, box.y, box.z),
        transformPoint(box.x + box.width, box.y + box.height, box.z),
        transformPoint(box.x, box.y, box.z + box.depth),
        transformPoint(box.x, box.y + box.height, box.z + box.depth),
        transformPoint(box.x + box.width, box.y, box.z + box.depth),
        transformPoint(box.x + box.width, box.y + box.height, box.z + box.depth)
    };
